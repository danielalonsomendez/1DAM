...
public class MenuRE1 {
	...
	public void likeMensaje() {
		Publicacion publicacion = seleccionarPublicacion();
	...
	public void comentarMensaje() {
		...
		publicacion.AñadirComentario(teclado.nextLine());
	}
	...
	public Publicacion pedirPublicacion() {
		return new Publicacion(pedirUsuario());
	}

	public Mensaje pedirMensajeTexto() {
		System.out.print("Introduce el texto a publicar: ");
		String contenido = teclado.nextLine();
		Publicacion publicacion = pedirPublicacion();
		return new Mensaje(publicacion.getid_Usuario(), contenido);
	}
	...
	public Foto pedirFoto() {
		...
		Publicacion publicacion = pedirPublicacion();
		return new Foto(publicacion.getid_Usuario(), nombreArchivo, titulo);
	}
